...
/**
 * Service class for trading calculations and analysis using the trader extension.
 */
class TraderService implements TraderInterface
{
    /**
     * @var array<int, string> The error messages.
     */
